...
samples_information = all.samples %>% filter(tissue == "Sangre") %>% select(analysisId, sampleId, version_panel, individualProgenyId)
...
# There are 292 samples without clasification
